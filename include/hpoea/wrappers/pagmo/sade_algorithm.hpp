...
class PagmoSelfAdaptiveDE final : public core::IEvolutionaryAlgorithm {
public:
    PagmoSelfAdaptiveDE();

    PagmoSelfAdaptiveDE(const PagmoSelfAdaptiveDE &other);

    PagmoSelfAdaptiveDE &operator=(const PagmoSelfAdaptiveDE &other);

    PagmoSelfAdaptiveDE(PagmoSelfAdaptiveDE &&) noexcept = default;
    PagmoSelfAdaptiveDE &operator=(PagmoSelfAdaptiveDE &&) noexcept = default;

    ~PagmoSelfAdaptiveDE() override = default;
...
class PagmoSelfAdaptiveDEFactory final : public core::IEvolutionaryAlgorithmFactory {
public:
